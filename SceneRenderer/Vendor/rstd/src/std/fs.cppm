...
public:
...
#if RSTD_OS_UNIX
#ifdef RSTD_OS_APPLE
        // macOS stat exposes the timespec as st_mtimespec, not st_mtim.
        return Ok(rstd::time::SystemTime { rstd::sys::pal::unix::time::SystemTime {
            rstd::sys::pal::unix::time::Timespec {
                i64(st_.st_mtimespec.tv_sec), u32(st_.st_mtimespec.tv_nsec) } } });
#else
        return Ok(rstd::time::SystemTime { rstd::sys::pal::unix::time::SystemTime {
            rstd::sys::pal::unix::time::Timespec {
    ...
    auto accessed() const -> Result<rstd::time::SystemTime> {
        ...
        return Ok(rstd::time::SystemTime { rstd::sys::pal::unix::time::SystemTime {
            rstd::sys::pal::unix::time::Timespec {
                i64(st_.st_atimespec.tv_sec), u32(st_.st_atimespec.tv_nsec) } } });
#else
        return Ok(rstd::time::SystemTime { rstd::sys::pal::unix::time::SystemTime {
            rstd::sys::pal::unix::time::Timespec {
